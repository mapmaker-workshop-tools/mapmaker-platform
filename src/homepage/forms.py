...
tailwind_class = """class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-steunkleur-500 focus:border-steunkleur-500 block w-full p-2.5     dark:focus:ring-steunkleur-500 dark:focus:border-steunkleur-500"""
